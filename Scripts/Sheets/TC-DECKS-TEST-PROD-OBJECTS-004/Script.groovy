...
String testUrl       = 'https://decks-test.templet.io/admin/manager.php'
String prodUrl       = 'https://deck.templet.io/admin/manager.php'
...
if (mismatches.isEmpty()) {
	KeywordUtil.markPassed('TC-DECKS-TEST-PROD-OBJECTS-004 OK.')
} else {
	KeywordUtil.markFailed('TC-DECKS-TEST-PROD-OBJECTS-004 diferencias: ' + mismatches.join(' | '))
}
