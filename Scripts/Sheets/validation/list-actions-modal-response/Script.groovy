...
String caseId = 'TC-SHEETS-LIST-ACTIONS-MODAL-001'
...
try {
    ...
    // Cambiar a List View
    def listViewIcon = findTestObject('Sheets/Objects/ListView/icon_list_view')
    def listShape = findTestObject('Sheets/Objects/ListView/icon_list_shape')
