...
String caseId = 'TC-DECKS-SORT-VALIDATION-001'
...
try {
    ...
    Map selectedClient = CommonKeywords.selectPreferredOption('Decks/Filters/select_client', clientCss, 'BRAVA', 12)
    ...
    if (failures.isEmpty()) {
        KeywordUtil.markPassed("${caseId} OK. Sort funciona en Decks.")
    } else {
