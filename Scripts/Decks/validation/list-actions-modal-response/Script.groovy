...
String caseId = 'TC-DECKS-LIST-ACTIONS-MODAL-001'
...
try {
    ...
    // Cambiar a List View
    def listViewIcon = findTestObject('Decks/Objects/ListView/icon_list_view')
    def listShape = findTestObject('Decks/Objects/ListView/icon_list_shape')
    ...
    def actions = [
        ...
        [id: 'url',       labels: ['URL', 'Copy URL', 'Copiar URL']],
