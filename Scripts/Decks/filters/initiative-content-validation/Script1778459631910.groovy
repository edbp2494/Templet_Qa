...
/**
 * TC-DECKS-FILTERS-INITIATIVE-VALIDATION-008
 * Objetivo:
...
String snapDir = System.getProperty('user.dir') + '/Reports/Screenshots/TC-DECKS-INITIATIVE-008'
...
try {
	...
	if (!browserAlreadyOpen) {
		...
		WebUI.navigateToUrl(decksTestUrl.replace('manager.php', 'login.php'))
	...
	KeywordUtil.markPassed('TC-DECKS-INITIATIVE-008: Initiative validado. Evidencias en ' + snapDir)
} finally {
