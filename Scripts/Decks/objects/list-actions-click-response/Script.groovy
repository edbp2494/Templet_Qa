// ─────────────────────────────────────────────────────────────────────────────
// TC: TC-DECKS-LIST-ACTIONS-RESPONSE-003
// Plataforma: Decks | Área: objects
// Descripción: Hace click en cada acción del menú de List View y valida señal de respuesta UI.
// Suites: Master/Full-Regression, Platforms/Full-Validation-All-Platforms, Platforms/Super-Suite-Validation, Platforms/Decks/Decks-Full-Regression-ReuseDriver, Platforms/Decks/Decks-List-Actions-Response-ReuseDriver
...
String caseId = 'TC-DECKS-LIST-ACTIONS-RESPONSE-003'
...
try {
    ...
    try {
        browserAlreadyOpen = WebUI.verifyElementPresent(findTestObject('Decks/Filters/section_dashboard'), 5, FailureHandling.OPTIONAL)
    } catch (Exception ignored) {}
    ...
    Map selectedClient = CommonKeywords.selectPreferredOption('Decks/Filters/select_client', clientCss, 'BRAVA', 10)
