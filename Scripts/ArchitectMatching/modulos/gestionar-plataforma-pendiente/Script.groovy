// ─────────────────────────────────────────────────────────────────────────────
// TC: TC-ARCHMATCH-MODULOS-GESTION-003
// Plataforma: ArchitectMatching | Área: modulos
// Descripción: PLACEHOLDER: modulo Gestionar plataforma visto en el home, pendiente de mapeo de detalle.
...
/*
 * TC-ARCHMATCH-MODULOS-GESTION-003 — PLACEHOLDER del modulo "Gestionar plataforma" (boton "Gestionar plataforma" en el home de Architect Matching).
 * Sin mapeo de detalle aun. TODO: explorar el modulo, mapear DOM (element-map) y
 * reemplazar este placeholder por asserts reales.
 */

String caseId = 'TC-ARCHMATCH-MODULOS-GESTION-003'
List failures = []
List warnings = []
...
try {
    ...
    WebUI.click(findTestObject('ArchitectMatching/Home/btn_por_texto', ['texto': 'Gestionar plataforma']))
    WebUI.delay(3)
    WebUI.takeScreenshot()
    warnings.add('[PENDIENTE] Placeholder: mapear DOM del modulo Gestionar plataforma y agregar asserts reales.')
} catch (Exception e) {
