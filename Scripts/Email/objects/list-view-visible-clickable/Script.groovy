...
String caseId = 'TC-EMAIL-LIST-VIEW-CLICKABLE-002'
String startUrl = CustomKeywords.'CommonKeywords.getRequiredGlobal'('EMAIL_TEST_URL', 'https://emails-test.templet.io/admin/manager.php')
