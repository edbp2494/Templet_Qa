...
CustomKeywords.'ReposCoverageKeywords.validateScreenFromElementMap'([
	caseId          : 'TC-BUILDERS-WIP-DASHBOARD-001',
	mapRelativePath : 'Include/config/element-maps/builders-work-in-progress.json',
	snapshotSlug    : 'tc_builders_wip_dashboard_001'
])
